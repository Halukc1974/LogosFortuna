...
description: >
  ...
  ve fizik kategorisi baglantllarini haritalandirmak gerekiyor.
  </commentary>
  </example>
  ...
  <example>
  Context: Kullanici mimari bir degisiklik planlliyor
...
- **Test Kapsamai**: [etkilenen alanlarin test durumu]
